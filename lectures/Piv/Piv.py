...
# analyzes node centrality of various real networks

analysis(Graph.pajek('karate_club'))
analysis(Graph.pajek('dolphins'))
analysis(Graph.pajek('football'))
analysis(Graph.pajek('lovrosubelj'))
analysis(Graph.pajek('imdb'))
...
# writes GoT kills network to default file

Graph.write(G)

# analyzes node centrality of GoT kills network
