...
class Graph:
  ...
  def write(G, path = '.'):
    ...
    Function returns graph G represented by class Graph.
    """
    with open(os.path.join(path, G.get_ + '.net'), 'w') as file:
...
# demo graph G represented class Graph
...
# prints out standard information of path graph P represented by class Path

print(Path("path", 10))

# prints out standard information of cycle graph C represented by class Cycle

print(Cycle("cycle", 10))

# prints out standard information of various real networks

print(Graph.pajek('karate_club'))
print(Graph.pajek('dolphins'))
print(Graph.pajek('football'))
print(Graph.pajek('lovrosubelj'))
print(Graph.pajek('imdb'))
