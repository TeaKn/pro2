...
public class Quoridor {
  ...
  public void reset(boolean first) {
    players[first? 0: 1] = new Player(first);
...
class GUI extends JFrame {
  ...
  public GUI(Quoridor quoridor) {
    ...
    menu = new JMenu("Game");
      ...
      item = new JMenuItem("Reset " + quoridor.getPlayers()[0].getName());
      item.setAccelerator(KeyStroke.getKeyStroke(quoridor.getPlayers()[0].getName().charAt(0), ActionEvent.SHIFT_MASK));
      item.addActionListener(new ActionListener() {
      ...
      item = new JMenuItem("Reset " + quoridor.getPlayers()[1].getName());
      item.setAccelerator(KeyStroke.getKeyStroke(quoridor.getPlayers()[1].getName().charAt(0), ActionEvent.SHIFT_MASK));
      item.addActionListener(new ActionListener() {
