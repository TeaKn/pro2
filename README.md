...
Python code and materials assume that the following modules are installed: [http.client](https://docs.python.org/3/library/http.client.html), [requests](http://docs.python-requests.org/en/master/), [matplotlib](https://matplotlib.org) and [numpy](http://www.numpy.org).
